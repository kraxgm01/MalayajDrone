...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1257getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m264toStringimpl(this.first)).append("..").append(ULong.m264toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m264toStringimpl(this.first)).append(" downTo ").append(ULong.m264toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1281fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
