...
public abstract class FirebaseAuth implements InternalAuthProvider {
    ...
    public FirebaseAuth(FirebaseApp firebaseApp, Provider provider) {
        zzwq zzb2;
        zztq zztq = new zztq(firebaseApp);
        ...
        this.zze = (zztq) Preconditions.checkNotNull(zztq);
    ...
    static void zzH(FirebaseAuth firebaseAuth, FirebaseUser firebaseUser, zzwq zzwq, boolean z, boolean z2) {
        boolean z3;
        boolean z4;
    ...
    public Task<AuthResult> signInWithCredential(AuthCredential credential) {
        ...
        if (zza2 instanceof EmailAuthCredential) {
            ...
            if (zzM(Preconditions.checkNotEmpty(emailAuthCredential.zzf()))) {
                return Tasks.forException(zztu.zza(new Status(17072)));
            }
    ...
    public final void zzE(FirebaseUser firebaseUser, zzwq zzwq, boolean z) {
        zzH(this, firebaseUser, zzwq, true, false);
    }
    ...
    public final void zzJ(String str, long j, TimeUnit timeUnit, PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Activity activity, Executor executor, boolean z, String str2, String str3) {
        ...
        String str4 = str;
        this.zze.zzO(this.zza, new zzxd(str, convert, z, this.zzi, this.zzk, str2, zzK(), str3), zzL(str, onVerificationStateChangedCallbacks), activity, executor);
    }

    /* access modifiers changed from: package-private */
    public final boolean zzK() {
        return zztz.zza(getApp().getApplicationContext());
    }
    ...
    public final Task zzb(FirebaseUser firebaseUser, MultiFactorAssertion multiFactorAssertion, String str) {
        ...
        if (!(multiFactorAssertion instanceof PhoneMultiFactorAssertion)) {
            return Tasks.forException(zztu.zza(new Status(FirebaseError.ERROR_INTERNAL_ERROR)));
        }
