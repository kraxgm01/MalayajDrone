...
public final class UStringsKt {
    ...
    public static final String m1343toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1345toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1344toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1342toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m192unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m141constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m192unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m141constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m319boximpl(UShort.m325constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m141constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m394uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m141constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m141constructorimpl(UInt.m141constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m135boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m219constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m396ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m219constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m219constructorimpl(ULong.m219constructorimpl(((long) UInt.m141constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m213boximpl(result);
    }
}
