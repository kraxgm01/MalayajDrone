...
public final class zzmh implements zzat {
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        int length = bArr.length;
        if (length >= 16) {
            Cipher cipher = (Cipher) zzmt.zza.zza("AES/CTR/NoPadding");
            ...
            if (copyOfRange2.length == 0 && doFinal == null && zznl.zzb()) {
                doFinal = new byte[0];
            }
            ...
            for (int i = 0; i <= 0; i++) {
                ...
                zza2 = zzmj.zzd(zzmi.zzb(zza2), this.zzc.zza(bArr6, 16));
            }
            byte[] bArr7 = bArr5[1];
            ...
            if (length2 >= 16) {
                ...
                bArr3 = zzmj.zzd(zzmi.zza(bArr7), zzmi.zzb(zza2));
            }
            if (zzmj.zzb(copyOfRange, this.zzc.zza(bArr3, 16))) {
                return doFinal;
            }
