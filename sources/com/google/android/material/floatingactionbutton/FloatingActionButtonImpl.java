...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(float targetOpacity, float targetScale, float targetIconScale) {
        ...
        AnimatorSetCompat.playTogether(set, animators);
        set.setDuration((long) MotionUtils.resolveThemeDuration(this.view.getContext(), R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(R.integer.material_motion_duration_long_1)));
