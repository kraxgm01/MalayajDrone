...
class ConnectionHolder implements ServiceConnection {
    ...
    public /* synthetic */ Object m4lambda$getServiceWrapper$0$androidxbrowsertrustedConnectionHolder(CallbackToFutureAdapter.Completer completer) throws Exception {
        switch (this.mState) {
            case 0:
