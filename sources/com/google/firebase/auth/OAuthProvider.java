...
public class OAuthProvider extends FederatedAuthProvider {
    ...
    public static class Builder {
        ...
        public OAuthProvider build() {
            return new OAuthProvider(this.zza, (zzad) null);
        }
    ...
    public static class CredentialBuilder {
        ...
        /* synthetic */ CredentialBuilder(String str, zzac zzac) {
            this.zza = str;
        }
    ...
    /* synthetic */ OAuthProvider(Bundle bundle, zzad zzad) {
        this.zza = bundle;
    }
    ...
    public static CredentialBuilder newCredentialBuilder(String providerId) {
        return new CredentialBuilder(Preconditions.checkNotEmpty(providerId), (zzac) null);
    }
