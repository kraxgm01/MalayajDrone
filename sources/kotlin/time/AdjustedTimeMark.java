...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1354minusLRDsOJo(long duration) {
    ...
    public TimeMark m1355plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1396plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
