...
final class zzzg {
    ...
    private zzzg(zzzf zzzf) {
        zzaad.zzf(zzzf, "output");
        this.zza = zzzf;
        zzzf.zze = this;
    }

    public static zzzg zza(zzzf zzzf) {
        zzzg zzzg = zzzf.zze;
        return zzzg != null ? zzzg : new zzzg(zzzf);
    }
    ...
    public final void zze(int i, List list) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            this.zza.zzQ(i, (zzyu) list.get(i2));
        }
    }
    ...
    public final void zzq(int i, Object obj, zzabo zzabo) throws IOException {
        zzzf zzzf = this.zza;
        zzzf.zzq(i, 3);
        zzabo.zzn((zzabc) obj, zzzf.zze);
        zzzf.zzq(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzabo zzabo) throws IOException {
        this.zza.zzn(i, (zzabc) obj, zzabo);
    }
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzzf.zzE((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
                zzzf zzzf = this.zza;
                int intValue2 = ((Integer) list.get(i2)).intValue();
                zzzf.zzs((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzzf2.zzr(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzzf.zzF((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
                zzzf zzzf = this.zza;
                long longValue2 = ((Long) list.get(i2)).longValue();
                zzzf.zzu((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzzf2.zzt(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzI(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzzf.zzE(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
    ...
    public final void zzK(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzzf.zzF(((Long) list.get(i4)).longValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzzf.zzy(((Integer) list.get(i4)).intValue());
            }
            this.zza.zzs(i3);
            while (i2 < list.size()) {
