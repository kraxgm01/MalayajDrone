...
final class zzyw extends zzyy {
    ...
    public final int zzc(int i) throws zzaaf {
        if (i >= 0) {
            int i2 = i + this.zzh;
            if (i2 >= 0) {
                int i3 = this.zzj;
    ...
    public final zzyu zzj() throws IOException {
        ...
        if (zze2 > 0) {
            ...
            int i2 = this.zzh;
            if (zze2 <= i - i2) {
                zzyu zzo = zzyu.zzo(this.zze, i2, zze2);
                this.zzh += zze2;
                return zzo;
            }
        }
        ...
        if (zze2 > 0) {
            ...
            if (zze2 <= i3 - i4) {
                int i5 = zze2 + i4;
                this.zzh = i5;
                return zzyu.zzq(Arrays.copyOfRange(this.zze, i4, i5));
            }
        }
        if (zze2 <= 0) {
            throw zzaaf.zzf();
    ...
    public final String zzk() throws IOException {
        ...
        if (zze2 > 0) {
            ...
            int i2 = this.zzh;
            if (zze2 <= i - i2) {
                String str = new String(this.zze, i2, zze2, zzaad.zzb);
                this.zzh += zze2;
                return str;
            }
        }
    ...
    public final String zzl() throws IOException {
        ...
        if (zze2 > 0) {
            ...
            int i2 = this.zzh;
            if (zze2 <= i - i2) {
                String zzd = zzacu.zzd(this.zze, i2, zze2);
                this.zzh += zze2;
                return zzd;
            }
        }
    ...
    public final void zzm(int i) throws zzaaf {
        if (this.zzi != i) {
            throw zzaaf.zzb();
        }
    }
    ...
    public final int zze() throws java.io.IOException {
        ...
        L_0x006f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzyw.zze():int");
    }
