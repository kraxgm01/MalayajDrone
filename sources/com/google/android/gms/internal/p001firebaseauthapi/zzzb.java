...
final class zzzb extends zzzf {
    ...
    public final void zzn(int i, zzabc zzabc, zzabo zzabo) throws IOException {
        zzs((i << 3) | 2);
    ...
    public final void zzp(String str) throws IOException {
        ...
        try {
            ...
            if (zzE2 == zzE) {
                int i2 = i + zzE2;
                this.zzc = i2;
                int zzb2 = zzacu.zzb(str, this.zza, i2, this.zzb - i2);
                this.zzc = i;
                zzs((zzb2 - i) - zzE2);
                this.zzc = zzb2;
                return;
            ...
            byte[] bArr = this.zza;
            int i3 = this.zzc;
            this.zzc = zzacu.zzb(str, bArr, i3, this.zzb - i3);
        } catch (zzact e) {
            this.zzc = i;
            zzJ(str, e);
    ...
    public final void zzu(long j) throws IOException {
        if (!zzzf.zzb || this.zzb - this.zzc < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zza;
                int i = this.zzc;
                this.zzc = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzc;
                this.zzc = i3 + 1;
                zzacp.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zza;
            int i4 = this.zzc;
            this.zzc = i4 + 1;
            zzacp.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
