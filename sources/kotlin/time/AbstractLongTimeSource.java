...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark m1350minusLRDsOJo(long duration) {
        ...
        public TimeMark m1351plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1396plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
