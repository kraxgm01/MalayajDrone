...
public class RecaptchaActivity extends FragmentActivity implements zzty {
    ...
    private static final ExecutorService zzc = zzf.zza().zza(2);
    ...
    public final void onResume() {
        ...
        if ("android.intent.action.VIEW".equals(getIntent().getAction())) {
            ...
            try {
                new zztw(packageName, Hex.bytesToStringUppercase(AndroidUtilsLight.getPackageCertificateHashBytes(this, packageName)).toLowerCase(Locale.US), intent3, FirebaseApp.getInstance(intent3.getStringExtra("com.google.firebase.auth.internal.FIREBASE_APP_NAME")), this).executeOnExecutor(zzc, new Void[0]);
