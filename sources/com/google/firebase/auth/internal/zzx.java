...
public final class zzx extends FirebaseUser {
    ...
    public final String getTenantId() {
        Map map;
        zzwq zzwq = this.zza;
        if (zzwq == null || zzwq.zze() == null || (map = (Map) zzay.zza(zzwq.zze()).getClaims().get(FirebaseAuthProvider.PROVIDER_ID)) == null) {
            return null;
        }
    ...
    zzx(zzwq zzwq, zzt zzt, String str, String str2, List list, List list2, String str3, Boolean bool, zzz zzz, boolean z, zze zze2, zzbb zzbb) {
        this.zza = zzwq;
        this.zzb = zzt;
        this.zzc = str;
        this.zzd = str2;
