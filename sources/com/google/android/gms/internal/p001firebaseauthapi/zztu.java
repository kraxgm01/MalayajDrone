...
public final class zztu {
    ...
    public static FirebaseAuthMultiFactorException zzc(FirebaseAuth firebaseAuth, zzqe zzqe, FirebaseUser firebaseUser) {
        if (firebaseAuth == null) {
            ...
            List<MultiFactorInfo> zzc = zzqe.zzc();
            ...
            return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag.zzb(zzqe.zzc(), zzqe.zzb()), firebaseAuth.getApp().getName(), zzqe.zza(), (zzx) firebaseUser));
        } else {
            throw null;
        }
    }
