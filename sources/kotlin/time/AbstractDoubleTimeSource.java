...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark m1347minusLRDsOJo(long duration) {
            return TimeMark.DefaultImpls.m1498minusLRDsOJo(this, duration);
        }
        ...
        public TimeMark m1348plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1396plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
