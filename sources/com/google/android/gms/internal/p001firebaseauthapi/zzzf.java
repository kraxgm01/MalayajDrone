...
public abstract class zzzf extends zzyk {
    private static final Logger zza = Logger.getLogger(zzzf.class.getName());
    /* access modifiers changed from: private */
    public static final boolean zzb = zzacp.zzx();
    zzzg zze;

    private zzzf() {
    }

    /* synthetic */ zzzf(zzze zzze) {
    }

    static int zzA(zzabc zzabc, zzabo zzabo) {
        zzye zzye = (zzye) zzabc;
        int zzn = zzye.zzn();
        if (zzn == -1) {
            zzn = zzabo.zza(zzye);
            zzye.zzp(zzn);
    ...
    public static int zzC(String str) {
        ...
        try {
            ...
            i = str.getBytes(zzaad.zzb).length;
        }
        return zzE(i) + i;
    }
    ...
    public static zzzf zzG(byte[] bArr) {
        return new zzzb(bArr, 0, bArr.length);
    }

    public static zzzf zzH(OutputStream outputStream, int i) {
    ...
    @Deprecated
    static int zzx(int i, zzabc zzabc, zzabo zzabo) {
        int zzE = zzE(i << 3);
        int i2 = zzE + zzE;
        zzye zzye = (zzye) zzabc;
        int zzn = zzye.zzn();
    ...
    public static int zzz(zzaai zzaai) {
        int zza2 = zzaai.zza();
    ...
    public final void zzJ(String str, zzact zzact) throws IOException {
        zza.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzact);
        byte[] bytes = str.getBytes(zzaad.zzb);
        try {
    ...
    /* access modifiers changed from: package-private */
    public abstract void zzn(int i, zzabc zzabc, zzabo zzabo) throws IOException;
