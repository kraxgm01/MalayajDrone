...
final class zzacu {
    private static final zzacr zza = new zzacs();

    static {
        if (zzacp.zzx() && zzacp.zzy()) {
            int i = zzyg.zza;
        }
    }
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzaaf {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzacq.zzd(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i7 = i6 + 1;
                        zzacq.zzb(b2, bArr[i6], bArr[i7], cArr, i3);
                        r11 = i7 + 1;
                        i3++;
                    } else {
                        throw zzaaf.zzd();
                    ...
                    int i8 = i6 + 1;
                    int i9 = i8 + 1;
                    zzacq.zza(b2, bArr[i6], bArr[i8], bArr[i9], cArr, i3);
                    i3 += 2;
                    r11 = i9 + 1;
                } else {
                    throw zzaaf.zzd();
