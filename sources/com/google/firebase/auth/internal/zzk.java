...
public final class zzk {
    ...
    private zzk(Context context, String str, boolean z) {
        ...
        try {
            zzeh.zza();
            zzff zzff = new zzff();
            zzff.zzf(context, "GenericIdpKeyset", String.format("com.google.firebase.auth.api.crypto.%s", new Object[]{str}));
            zzff.zzd(zzem.zza);
            zzff.zze(String.format("android-keystore://firebear_master_key_id.%s", new Object[]{str}));
            zzfh = zzff.zzg();
    ...
    public final String zzc() {
        ...
        zzbi zza2 = zzaq.zza(byteArrayOutputStream);
        try {
